...
server <- function(input, output,session) {
  ...
  output$models <- renderText({
    if(input$existed_data_use){
      Remodelling(FALSE,FALSE,FALSE)
      #done <- models
     #exists("rf_C12")
     #"rf_A09,rf_A10,rf_A11,rf_A12,rf_A13,rf_A14,rf_B06,rf_B07,rf_B08,rf_B09,rf_B10,rf_B11,rf_B12,rf_B13,rf_B14,rf_B15,rf_B16,rf_B17,rf_C05,rf_C06,rf_C07,rf_C08,rf_C09,rf_C10,rf_C11,rf_C12,rf_C13,rf_C14,rf_C15,rf_C16,rf_C17,rf_C18"
      #done
    }
  }
  )
